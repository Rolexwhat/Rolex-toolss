...
kapanis = datetime.datetime(2025, 6 , 1 , 10, 00)  

# Tarih ve saat kontrolü
if x > kapanis:
    print('\n\n')
    print("\033[1;33m" + 'Api durduruldu. Satın almak için yaz ---->\033[1;32m@Rolexwhat')
    print('\n\n')
    print(x)
    sys.exit(0)
...
U = 0
o = {}
A5 = w("{WHAT         META    V4}", colors=["green", "red"], align="center")
V(
    f"""
[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                      {A5}
...
"""
    ...
    K.print(L)
    with W("Rolexwhat instaHit.txt", "a") as M:
        M.write(H + "\n")
    try:
